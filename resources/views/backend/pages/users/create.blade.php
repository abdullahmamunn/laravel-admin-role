        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{route('users.create')}}">New User Create</a></li>
		...
		@endif
	 	<form action="{{route('users.store')}}" method="post">
			...
			<div class="form-group">
			    ...
			    <input type="text" class="form-control" name="name" id="exampleInputName" aria-describedby="roleHelp" placeholder="Enter Name">
			    @error('name')
 			...
 			<div class="form-group">
			    ...
			    <input type="email" class="form-control" name="email" id="exampleEmailName" aria-describedby="roleHelp" placeholder="Enter Email">
			    @error('email')
				    <div class="alert alert-danger">{{ $message }}</div>
				@enderror
 			</div>
